...
- Executed two stub probes of upstream retrieve_note: [output](results/source-probe/probes.json), [manifest](results/source-probe/manifest.json).
...
The probes establish control behavior, not note quality, retrieval gains, or long-term value. A representation experiment remains future work with its own protocol and outputs; it is not backfilled into v0.1.1 or frozen E1–E4.
